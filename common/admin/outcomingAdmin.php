	...
	<body>
		<div class="wrapper">
			...
			<div id="content">
				...
				<h1 class="display-4">Minute Meeting</h1>
				<br />

                <form action="typeProcessAdmin.php" method="POST">
				...
				<table  id="main_table" class="table table-bordered">
					...
					<tbody>
						...
						$sql= "Select * from min m join systemuser s on m.min_staffid = s.staffid where type='outcoming'";
